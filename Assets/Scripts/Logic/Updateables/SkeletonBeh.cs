...
public class SkeletonBeh : MonoBehaviour,ILivingEntity,IAttackableEntityTarget
{
    ...
    public void DieWithKnockback(Vector3 knockback)
    {
      ...
      //  cc.enabled = true;
        ...
        VoxelWorld.currentWorld.itemEntityManager.SpawnNewItem(transform.position.x, transform.position.y + 1.5f, transform.position.z, 157, new Vector3(Random.Range(-3f, 3f), Random.Range(-3f, 3f), Random.Range(-3f, 3f)));
    ...
    public void ApplyDamageAndKnockback(float damageAmount, Vector3 knockback)
    {
        ...
        {
            AS.PlayOneShot(GlobalGameResourcesManager.instance.audioResourcesManager.TryGetEntityAudioClip("skeletonHurtClip"));
        }
    ...
    public async void Attack()
    {
        if (attackCD <= 0f)
        {
            ...
            EntityBeh arrow=VoxelWorld.currentWorld.entityManager.SpawnNewEntity(arrowPos.x, arrowPos.y, arrowPos.z, 4,headTransform.forward);
           ...
           AS.PlayOneShot(GlobalGameResourcesManager.instance.audioResourcesManager.TryGetEntityAudioClip("skeletonShootClip"));
   ...
   public Vector3 targetPos;
    ...
    public void FixedUpdate()
    {
        ...
        {
            AS.PlayOneShot(GlobalGameResourcesManager.instance.audioResourcesManager.TryGetEntityAudioClip("skeletonIdleClip"));
        }
