...
{   
    ...
    public static bool isZombiePrefabLoaded=false;
     ...
     public void ApplyDamageAndKnockback(float damageAmount,Vector3 knockback){
         ...
         {
             AS.PlayOneShot(GlobalGameResourcesManager.instance.audioResourcesManager.TryGetEntityAudioClip("zombieHurtClip"));
        }
    ...
    isDied = true;
        ...
        //    cc.enabled=true;
            ...
            VoxelWorld.currentWorld.itemEntityManager.SpawnNewItem(transform.position.x,transform.position.y + 0.9f, transform.position.z,154,new Vector3(Random.Range(-3f,3f),Random.Range(-3f,3f),Random.Range(-3f,3f)));
    ...
    public void FixedUpdate(){
        ...
        {
            AS.PlayOneShot(GlobalGameResourcesManager.instance.audioResourcesManager.TryGetEntityAudioClip("zombieIdleClip"));
        }
