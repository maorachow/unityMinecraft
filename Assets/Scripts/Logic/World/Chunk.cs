...
//    public static Transform playerPos;
   ...
   */
    ...
    public void SaveSingleChunkToDictionary(ref ConcurrentDictionary<Vector2Int,ChunkData> dictionary)
    {
        if (!isChunkPosInited)
        {
            return;
        ...
        if (dictionary.ContainsKey(chunkPos))
        {
            ...
            dictionary.TryRemove(chunkPos, out _);
        ...
        Mesh.MeshDataArray mdaLOD1, Mesh.MeshDataArray mdaLOD2,Mesh.MeshDataArray mdaTS)
    {
        lock (taskLock)
        {
            ...
            NativeList<Vector3> opqVertsNL = new NativeList<Vector3>(Allocator.Persistent);
            NativeList<Vector3> opqNormsNL = new NativeList<Vector3>(Allocator.Persistent);
            NativeList<Vector3> opqTangentsNL = new NativeList<Vector3>(Allocator.Persistent);
            NativeList<Vector2> opqUVsNL = new NativeList<Vector2>(Allocator.Persistent);
            NativeList<int> opqTrisNL = new NativeList<int>(Allocator.Persistent);
            NativeList<Vector3> NSVertsNL = new NativeList<Vector3>(Allocator.Persistent);
            NativeList<Vector3> NSNormsNL = new NativeList<Vector3>(Allocator.Persistent);
            NativeList<Vector3> NSTangentsNL = new NativeList<Vector3>(Allocator.Persistent);
            NativeList<Vector2> NSUVsNL = new NativeList<Vector2>(Allocator.Persistent);
            NativeList<int> NSTrisNL = new NativeList<int>(Allocator.Persistent);
            NativeList<Vector3> WTVertsNL = new NativeList<Vector3>(Allocator.Persistent);
            NativeList<Vector3> WTNormsNL = new NativeList<Vector3>(Allocator.Persistent);
            NativeList<Vector3> WTTangentsNL = new NativeList<Vector3>(Allocator.Persistent);
            NativeList<Vector2> WTUVsNL = new NativeList<Vector2>(Allocator.Persistent);
            NativeList<int> WTTrisNL = new NativeList<int>(Allocator.Persistent);

            NativeList<Vector3> TSVertsNL = new NativeList<Vector3>(Allocator.Persistent);
            NativeList<Vector3> TSNormsNL = new NativeList<Vector3>(Allocator.Persistent);
            NativeList<Vector3> TSTangentsNL = new NativeList<Vector3>(Allocator.Persistent);
            NativeList<Vector2> TSUVsNL = new NativeList<Vector2>(Allocator.Persistent);
            NativeList<int> TSTrisNL = new NativeList<int>(Allocator.Persistent);

            NativeList<Vector3> opqVertsLOD = new NativeList<Vector3>(Allocator.Persistent);
            NativeList<Vector3> opqNormsLOD = new NativeList<Vector3>(Allocator.Persistent);
            NativeList<Vector3> opqTangentsLOD = new NativeList<Vector3>(Allocator.Persistent);
            NativeList<Vector2> opqUVsLOD = new NativeList<Vector2>(Allocator.Persistent);
            NativeList<int> opqTrisLOD = new NativeList<int>(Allocator.Persistent);
