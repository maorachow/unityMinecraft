...
{
    public static Dictionary<int, AudioClip> blockAudioDictionary;

    public static Dictionary<string, AudioClip> entityAudioDictionary;


    public static void LoadDefaultBlockAudioResources()
    {
    ...
    public static AudioClip TryGetBlockAudioClip(int blockID)
    {
    ...
    public static AudioClip TryGetEntityAudioClip(string clipName)
    {
    ...
    public static void LoadDefaultEntityAudioResources()
    {
